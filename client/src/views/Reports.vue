...
export default {
  name: 'Reports',
  setup() {
    const { t, currentLocale, translateMonth } = useI18n()
    ...
    }, { watchSources: [selectedPeriod, selectedLocation, selectedCategory, selectedStatus], errorMessage: 'Failed to load reports' })
    ...
    const formatMonth = (monthStr) => {
      ...
      const abbrev = monthNames[monthIndex - 1]

      return `${translateMonth(abbrev)} ${year}`
    }
